...
const UpdatePost = () => {
  ...
  const onSubmit = async (data) => {
    data.status = POST_STATUS.UPDATE_PENDING;
    updatePostMutation.mutate(data);
  };
  const updatePostMutation = useMutation((data) => 
    mutationFn: postService.update(id, data),
   
  , {
    onSuccess:()=>toast.success("Gui yeu cau duyet bai thanh cong");
  });
